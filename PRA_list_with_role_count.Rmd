...
pra_filtered <- data |>
  ...
  dplyr::summarise("Individuals per Role" = dplyr::n()) |>
  dplyr::arrange(Title)

}

name_of_publication <- "Prescription Cost Analysis - England 2022/23"
...
df <- data.frame(title = c("Statistical Officer","Senior Statistical Officer", "Statistical Publication Lead"), "Individuals per Role" = c(2, 2, 1))
